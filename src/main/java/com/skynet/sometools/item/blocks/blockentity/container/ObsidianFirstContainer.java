package com.skynet.sometools.item.blocks.blockentity.container;
...
public class ObsidianFirstContainer extends Container {
    private final ObsidianFirstContainerItemNumber intArray;
    ...
    public ObsidianFirstContainer(int id, PlayerInventory playerInventory, BlockPos pos, World world,
        ...
        super(ContainerTypeRegister.OBSIDIAN_FIRST_CONTAINER.get(), id);
