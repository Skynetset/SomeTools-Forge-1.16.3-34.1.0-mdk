...
import com.skynet.sometools.list.item.armors.SomeToolsArmorMaterial;
import com.skynet.sometools.list.item.blocks.*;
...
import com.skynet.sometools.list.item.blocks.blockentity.container.ObsidianFirstContainerItemNumber;
import com.skynet.sometools.list.item.food.ObsidianApple;
import com.skynet.sometools.list.item.ingot.MagicIngot;
import com.skynet.sometools.list.item.itemstacktileentityrenderer.ObsidianWrenchItemStackTileEntityRenderer;
import com.skynet.sometools.list.item.sword.ObsidianSword;
import com.skynet.sometools.list.item.tools.*;
import com.skynet.sometools.list.item.tools.pickaxe.ObsidianPickaxe;
